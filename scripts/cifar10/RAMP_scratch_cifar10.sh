...
do
    CUDA_VISIBLE_DEVICES='0' python RAMP.py --lr-max 0.05  --lr-schedule=static --at_iter 10 --epochs 80 --save_freq 10 --eval_freq 10 --fname RAMP_beta_0.5_lbd_5_$seed --kl --max --final_eval --gp --lbd 5 --seed $seed
done
