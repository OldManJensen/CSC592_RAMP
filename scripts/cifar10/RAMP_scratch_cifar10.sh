...
do
    CUDA_VISIBLE_DEVICES='0' python RAMP.py --lr-max 0.05  --lr-schedule=step --lr-milestone 100 150 180 --at_iter 10 --epochs 200 --save_freq 20 --eval_freq 20 --fname RAMP_beta_0.5_lbd_5_$seed --kl --max --final_eval --gp --lbd 5 --seed $seed
done
